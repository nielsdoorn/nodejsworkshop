...
\subsubsection*{Exercises}
Create a program that displays the \textbf{hostname} and the \textbf{uptime} for your computer, using the `os' module. More information on the API of the OS module can be found here: \href{http://nodejs.org/api/os.html}{nodejs.org/api/os.html}.
